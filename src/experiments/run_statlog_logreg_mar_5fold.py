"""
Statlog Heart logistic regression under 5-fold MAR.
Saves:
- results/metrics/statlog_logreg_mar_5fold_metrics.csv
...
def main():
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(splits):
        ...
        for rate in rates:
            ...
            row = {
                ...
                "accuracy": mar_results["accuracy"],
                "roc_auc": mar_results["roc_auc"],
                "brier": mar_results["brier"],
                "accuracy_change": mar_results["accuracy"] - clean_results["accuracy"],
                "roc_auc_change": mar_results["roc_auc"] - clean_results["roc_auc"],
                "brier_change": mar_results["brier"] - clean_results["brier"],
            }
    ...
    results_df.to_csv("results/metrics/statlog_logreg_mar_5fold_metrics.csv", index=False)
    summary_df.to_csv("results/metrics/statlog_logreg_mar_5fold_summary.csv", index=False)

    print("\nSaved:")
    print("- results/metrics/statlog_logreg_mar_5fold_metrics.csv")
    print("- results/metrics/statlog_logreg_mar_5fold_summary.csv")
