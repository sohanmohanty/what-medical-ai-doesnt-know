...
def main():
    ...
    results_df.to_csv("results/metrics/wdbc_logreg_mcar_imputer_compare_metrics.csv", index=False)
    summary_df.to_csv("results/metrics/wdbc_logreg_mcar_imputer_compare_summary.csv", index=False)

    print("\nSaved:")
    print("- results/metrics/wdbc_logreg_mcar_imputer_compare_metrics.csv")
    print("- results/metrics/wdbc_logreg_mcar_imputer_compare_summary.csv")
