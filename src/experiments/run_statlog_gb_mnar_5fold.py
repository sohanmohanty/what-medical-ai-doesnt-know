...
def main():
    ...
    target_features = ["resting_blood_pressure", "serum_cholestoral", "maximum_heart_rate_achieved"]
    all_results = []
    ...
    results_df.to_csv("results/metrics/statlog_gb_mnar_5fold_metrics.csv", index=False)
    summary_df.to_csv("results/metrics/statlog_gb_mnar_5fold_summary.csv", index=False)

    print("Saved:")
    print("- results/metrics/statlog_gb_mnar_5fold_metrics.csv")
    print("- results/metrics/statlog_gb_mnar_5fold_summary.csv")
