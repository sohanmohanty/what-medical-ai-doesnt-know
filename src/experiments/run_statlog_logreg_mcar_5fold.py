"""
Statlog Heart logistic regression under 5-fold MCAR.
Saves:
- results/metrics/statlog_logreg_mcar_5fold_metrics.csv
...
def main():
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(splits):
        ...
        for rate in rates:
            ...
            row = {
                ...
                "accuracy": mcar_results["accuracy"],
                "roc_auc": mcar_results["roc_auc"],
                "brier": mcar_results["brier"],
                "accuracy_change": mcar_results["accuracy"] - clean_results["accuracy"],
                "roc_auc_change": mcar_results["roc_auc"] - clean_results["roc_auc"],
                "brier_change": mcar_results["brier"] - clean_results["brier"],
            }
    ...
    results_df.to_csv("results/metrics/statlog_logreg_mcar_5fold_metrics.csv", index=False)
    summary_df.to_csv("results/metrics/statlog_logreg_mcar_5fold_summary.csv", index=False)

    print("\nSaved:")
    print("- results/metrics/statlog_logreg_mcar_5fold_metrics.csv")
    print("- results/metrics/statlog_logreg_mcar_5fold_summary.csv")
