"""
WDBC logistic regression under 1-fold MNAR.
Saves no CSVs yet; intended as a validated stepping-stone script.
"""
...
def main():
    ...
    print("\nMNAR results (20% on mean texture, depending on mean texture itself):")
