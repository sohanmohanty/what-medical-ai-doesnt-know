...
def main():
    ...
    results_df.to_csv("results/metrics/statlog_gb_mar_5fold_metrics.csv", index=False)
    summary_df.to_csv("results/metrics/statlog_gb_mar_5fold_summary.csv", index=False)

    print("Saved:")
    print("- results/metrics/statlog_gb_mar_5fold_metrics.csv")
    print("- results/metrics/statlog_gb_mar_5fold_summary.csv")
