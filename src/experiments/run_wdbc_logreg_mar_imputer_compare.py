...
def main():
    print("STARTING MAR IMPUTER COMPARISON")
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(splits):
        ...
        for rate in rates:
            ...
            for imputer_name in imputers:
                ...
                results = evaluate_pipeline(pipeline, X_train_mar, X_test_mar, y_train, y_test)
    ...
    results_df.to_csv("results/metrics/wdbc_logreg_mar_imputer_compare_metrics.csv", index=False)
    summary_df.to_csv("results/metrics/wdbc_logreg_mar_imputer_compare_summary.csv", index=False)

    print("\nSaved:")
    print("- results/metrics/wdbc_logreg_mar_imputer_compare_metrics.csv")
    print("- results/metrics/wdbc_logreg_mar_imputer_compare_summary.csv")
