"""
Statlog Heart random forest under 5-fold MNAR.
Saves:
- results/metrics/statlog_rf_mnar_5fold_metrics.csv
...
def main():
    ...
    results_df.to_csv("results/metrics/statlog_rf_mnar_5fold_metrics.csv", index=False)
    summary_df.to_csv("results/metrics/statlog_rf_mnar_5fold_summary.csv", index=False)

    print("\nSaved:")
    print("- results/metrics/statlog_rf_mnar_5fold_metrics.csv")
    print("- results/metrics/statlog_rf_mnar_5fold_summary.csv")
