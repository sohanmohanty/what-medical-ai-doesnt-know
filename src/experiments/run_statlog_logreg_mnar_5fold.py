"""
Statlog Heart logistic regression under 5-fold MNAR.
Saves:
- results/metrics/statlog_logreg_mnar_5fold_metrics.csv
...
def main():
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(splits):
        ...
        for rate in rates:
            ...
            row = {
                ...
                "accuracy": mnar_results["accuracy"],
                "roc_auc": mnar_results["roc_auc"],
                "brier": mnar_results["brier"],
                "accuracy_change": mnar_results["accuracy"] - clean_results["accuracy"],
                "roc_auc_change": mnar_results["roc_auc"] - clean_results["roc_auc"],
                "brier_change": mnar_results["brier"] - clean_results["brier"],
            }
    ...
    results_df.to_csv("results/metrics/statlog_logreg_mnar_5fold_metrics.csv", index=False)
    summary_df.to_csv("results/metrics/statlog_logreg_mnar_5fold_summary.csv", index=False)

    print("\nSaved:")
    print("- results/metrics/statlog_logreg_mnar_5fold_metrics.csv")
    print("- results/metrics/statlog_logreg_mnar_5fold_summary.csv")
