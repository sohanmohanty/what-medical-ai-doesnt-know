...
def main():
    ...
    results_df.to_csv("results/metrics/statlog_logreg_iterative_calibration_metrics.csv", index=False)
    summary_df.to_csv("results/metrics/statlog_logreg_iterative_calibration_summary.csv", index=False)

    print("\nSaved:")
    print("- results/metrics/statlog_logreg_iterative_calibration_metrics.csv")
    print("- results/metrics/statlog_logreg_iterative_calibration_summary.csv")
