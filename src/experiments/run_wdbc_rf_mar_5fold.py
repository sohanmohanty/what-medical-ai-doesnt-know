"""
WDBC random forest under 5-fold MAR.
Saves:
- results/metrics/wdbc_rf_mar_5fold_metrics.csv
...
def main():
    ...
    results_df.to_csv("results/metrics/wdbc_rf_mar_5fold_metrics.csv", index=False)
    summary_df.to_csv("results/metrics/wdbc_rf_mar_5fold_summary.csv", index=False)

    print("\nSaved:")
    print("- results/metrics/wdbc_rf_mar_5fold_metrics.csv")
    print("- results/metrics/wdbc_rf_mar_5fold_summary.csv")
