...
def main():
    input_path = "results/metrics/wdbc_combined_model_mechanism_summary.csv"
    ...
    for mechanism in df["mechanism"].unique():
        ...
        plt.title(f"WDBC: Mean ROC-AUC by Model under {mechanism.upper()}")
        plt.legend()
        plt.tight_layout()

        output_path = output_dir / f"wdbc_{mechanism}_model_compare_auc.png"
