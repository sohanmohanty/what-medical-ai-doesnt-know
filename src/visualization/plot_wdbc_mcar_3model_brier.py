...
def main():
    ...
    output_path = "figures/wdbc_mcar_3model_brier.png"
    ...
    plt.errorbar(
        logreg_df["rate"],
        logreg_df["mean_brier"],
        yerr=logreg_df["std_brier"],
        marker="o",
        capsize=4,
    ...
    plt.title("WDBC MCAR: Mean Brier by Model")
    plt.legend()
    plt.tight_layout()
